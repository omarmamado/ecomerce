...
<html lang="en">
  ...
  <body>
    ...
    @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ url('admin/home') }}"><i class="icon ion-android-star-outline"></i> Motawr-Tech</a></div>
    ...
    {{-- <script src="{{ assetRT('backend') }}/lib/datatables-responsive/dataTables.responsive.js"></script> --}}
    <script>
      $(function(){
        'use strict';
